...
public abstract class EFBaseRepository<TEntity, TDbContext>: EFBaseRepository<TEntity, Guid, TDbContext>
    where TEntity : class, IDomainEntityId
    where TDbContext : DbContext
{
    protected EFBaseRepository(TDbContext dbContext) : base(dbContext)
    {
    }
}
    ...
    where TDbContext : DbContext
{
    ...
    protected EFBaseRepository(TDbContext dbContext)
    {
